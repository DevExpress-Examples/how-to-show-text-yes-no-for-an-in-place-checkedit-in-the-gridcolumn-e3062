...
Namespace _2374___InplaceCheckEditTemplate
	Public Class PersonsViewModel
		...
		Public Sub New()
			Dim Names As New List(Of String) (New String() {"Alex", "Effy", "Alice", "Tony", "Den", "John", "Donald", "Brian", "Andrew", "Lisa", "Matthew"})
			persons_Renamed = New ObservableCollection(Of Person)()
			For i As Integer = 0 To 9
				persons_Renamed.Add(New Person(Names(i), "Last name " & i, i Mod 3 = 0, i + 21, 170 + i, 75 + i))
			Next i
		End Sub
	...
	Public Class Person
		...
		Private Const isMarriedPropertyName As String = "IsMarried"
		Private Const agePropertyName As String = "Age"
		Private Const heightPropertyName As String = "Height"
		...
		Public Sub New(ByVal firstName As String, ByVal lastName As String, ByVal isMarried As Boolean, ByVal age As Integer, ByVal height As Integer, ByVal weight As Integer)
